...
tinymce.PluginManager.add('image', function(editor) {
	...
	function createImageList(callback,delOldWin) {
		return function() {
			...
			if (typeof(imageList) == "string") {
				tinymce.util.XHR.send({
					...
					success: function(text) {
						callback(tinymce.util.JSON.parse(text),delOldWin);
					}
				});
			} else {
				callback(imageList,delOldWin);
			}
		};
	}

	function showDialog(imageList,delOldWin) {
	...
	this.testme = createImageList(showDialog, true);

 ...
 */
	...
	***************************************************************************/
	...
	define_once('XML_ELEMENT_NODE', 1);
	define_once('XML_TEXT_NODE', 3);
	define_once('XML_CDATA_SECTION_NODE', 4);
	define_once('XML_COMMENT_NODE', 8);
	define_once('XML_DOCUMENT_NODE', 9);

	// Define exceptions codes
	define_once('XML_INDEX_SIZE_ERR', 1);
	define_once('XML_NOT_FOUND_ERR', 8);

	define_once('XML_NO_FILE_ERR', 100);
	define_once('XML_FILE_NOT_FOUND_ERR', 101);
	define_once('XML_UNABLE_TO_OPEN', 102);
	define_once('XML_UNABLE_TO_WRITE', 103);

	define_once('XML_UNABLE_TO_CONNECT', 110);
	define_once('XML_UNKNOWN_RESPONSE', 111);

	define_once('XML_TYPE_MISMATCH', 120);
...
//          replaced with foreach 2019-01-25 for php 7.2            
